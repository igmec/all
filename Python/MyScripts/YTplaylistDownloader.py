#! python3
#YTplaylistDownloader.py - downloads all youtube videos in a youtube playlist
...
url = 'https://www.youtube.com/playlist?list=PLeQDywpVOXtEjSEKr-KeBe20CKkcyivwz'
...
elems = soup.select('#pl-load-more-destination tr')
